...
- **Бонус: https://youtu.be/J1C7vzaRP-g**
...
- git с чистой историей коммитов (ну почти с чистой :))
- без лишних зависимостей
- код легко расширяется
- проект готов к реальному использованию протестированно на локальном но боевом Ubuntu server
